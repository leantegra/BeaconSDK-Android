...
1. Put [leantegra-android-sdk_1.2.0.aar](https://github.com/leantegra/AndroidWiBeatSDK/blob/master/WiBeatSDK/leantegra-android-sdk_1.2.0.aar) into project's `libs` directory; 
...
3. Add into `build.gradle` dependency to WiBeat SDK:
  ...
  ```groovy
  dependencies {
    compile(name:'leantegra-android-sdk_1.2.0', ext:'aar')
  }
```
